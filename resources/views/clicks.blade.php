                ...
                <ul class="list-group" style="height: 345px; overflow: hidden; overflow-y: scroll;">
                    @foreach($trackers as $tracker)
                        <li class="list-group-item">
                            ...
                            <span class="pull-right" style="margin-right: 20px"> {{$tracker->total}}</span><span class="pull-right" style="margin-right: 10px">Total Clicks :</span>
                            <span class="pull-right" style="margin-right: 50px"> {{$tracker->unique}}</span><span class="pull-right" style="margin-right: 10px">Unique Clicks :</span>
